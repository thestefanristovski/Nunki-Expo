...
class DropdownMenu extends Component {
  ...
  renderChcek(index, title) {
    ...
    if (this.state.selectIndex[activityIndex] == index) {
      ...
      return (
        <View style={{flex: 1, justifyContent: 'space-between', alignItems: "center", padding: 15, flexDirection: 'row', height:40}} >
    <Text
      style={[
  ...
  renderActivityPanel() {
    if (this.state.activityIndex >= 0) {
      ...
      var heightStyle = {};
      if (this.props.maxHeight && this.props.maxHeight < currentTitles.length * 100) {
